...
def _stream_response_to_file(
    ...
    *,
    ...
    if not first:
        raise RuntimeError("O download ficou vazio.")
    ...
    if suffix == ".bin" and (
        ...
        raise RuntimeError(
            "O servidor devolveu uma página HTML em vez de um documento."
        )
            ...
            try:
                if (
                    ...
                    if suffix == ".bin" and (
                        ...
                        raise RuntimeError(
                            "O servidor devolveu HTML em vez do documento."
                        )
                    target = base_target.with_suffix(
                        suffix
                    )
