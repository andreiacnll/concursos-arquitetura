...
URL_PESQUISA = "https://www.base.gov.pt/Base4/pt/pesquisa"

URL_RESULTADOS = "https://www.base.gov.pt/Base4/pt/resultados"

URL_DETALHE = "https://www.base.gov.pt/Base4/pt/detalhe"
...
def inicializar_sessao(
    ...
    """
    Abre a página pública do Portal BASE para iniciar cookies e sessão.

    O Portal usa rotas sem barra final. Em servidores IIS, adicionar a barra
    antes da query string pode devolver 404, mesmo quando a rota sem barra
    está disponível.
    """
