...
<section className="page-header">
      ...
      <section className="analysis-grid">
        ...
        <MetricCard
          ...
          valor={ficha.programa.areas.total}
        />


        <MetricCard
          titulo="Valor da obra"
          valor={ficha.investimento.valor_obra}
        />


        <MetricCard
          titulo="Prazo de projeto"
          valor={ficha.investimento.prazo_projeto}
        />
      ...
      <ScoreCard
        score={ficha.decisao.score}
        classificacao={ficha.decisao.classificacao}
        oportunidades={ficha.decisao.oportunidades}
        riscos={ficha.decisao.riscos}
      />
