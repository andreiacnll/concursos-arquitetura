...
export default function FavoritosPage() {
  ...
  return (
    <PrivateLayout>
      <main className="site-container favorites-page" style={{ paddingTop: "32px" }}>

        <header className="favorites-header" style={{ marginBottom: "28px" }}>
        ...
        <div className="favorites-tabs" style={{ display: "flex", gap: "10px", marginBottom: "24px" }}>
        ...
        {loading ? (
          ...
          <div className="favorites-list" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {filtrados.map((fav) => (
              <div key={fav.id} className="favorite-list-item" style={{
                display: "flex",
                alignItems: "center",
                gap: "16px",
                padding: "20px 24px",
