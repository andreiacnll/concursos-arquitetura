...
const categoryImages = {
  "Saúde": [
    "/categories/health-1.webp",
    "/categories/health-2.webp",
    "/categories/health-3.webp",
  ],

  "Habitação": [
    "/categories/housing-1.webp",
    "/categories/housing-2.webp",
    "/categories/housing-3.webp",
  ],

  "Escolas": [
    "/categories/education-1.webp",
    "/categories/education-2.webp",
    "/categories/education-3.webp",
  ],

  "Paisagismo": [
    "/categories/landscape-1.webp",
    "/categories/landscape-2.webp",
    "/categories/landscape-3.webp",
  ],

  "Espaço público": [
    "/categories/urbanism-1.webp",
    "/categories/urbanism-2.webp",
    "/categories/urbanism-3.webp",
  ],

  "Património": [
    "/categories/culture-1.webp",
    "/categories/culture-2.webp",
    "/categories/culture-3.webp",
  ],

  "Arquitetura": [
    "/categories/architecture-1.webp",
    "/categories/architecture-2.webp",
    "/categories/architecture-3.webp",
  ],
};
