    ...
    <header className="site-header">
      <div className="site-container navbar">
        <Link
          ...
          aria-label="BIRD"
        >
          <span className="bird-navbar-lockup">
            <Image
              src={isDark ? "/brand/bird-symbol-light.png" : "/brand/bird-symbol.png"}
              alt=""
              width={512}
              height={512}
              className="bird-navbar-symbol"
              priority
            />
            <Image
              src={isDark ? "/brand/bird-wordmark-light.png" : "/brand/bird-wordmark-transparent.png"}
              alt="BIRD"
              width={800}
              height={220}
              className="bird-navbar-wordmark"
              priority
            />
          </span>
        </Link>
